  ...
  <div>
    ...
    <section class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div class="flex items-center justify-between mb-10">
        <h2 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Latest Posts</h2>
        <NuxtLink
          to="/blog"
      ...
      <div v-else class="text-center py-12">
        <p class="text-gray-500 dark:text-gray-400">No posts yet. Start by adding content in the CMS.</p>
      </div>
    </section>
  </div>
</template>
